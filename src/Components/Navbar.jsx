...
function Navbar({ searchText, setSearchText }) {
  ...
  return (
    <div
      className="navbar font-mont bg-black/40 backdrop-blur-lg shadow-md text-white fixed top-0 left-0 right-0 z-50"
      style={{ zIndex: 1000 }}
    >
      <div className="w-11/12 mx-auto flex justify-between items-center">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={-1}
              className="menu menu-sm dropdown-content bg-black/40 backdrop-blur-lg rounded-box mt-3 w-52 p-2 shadow"
            >
              {link}
            </ul>
          </div>
        ...
        <div className="navbar-end flex gap-6">
          ...
          <div className="avatar">
            <div className="ring-[#facc15] ring-offset-black/40 rounded-full ring-2 ring-offset-2">
              <img
                className="w-8"
                src="https://i.ibb.co/ksFBV7CV/Shahriar-Raj-png.jpg"
                alt="User avatar"
              />
            </div>
          </div>
