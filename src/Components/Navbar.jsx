...
function Navbar() {
  ...
  <div className='w-11/12 mx-auto flex justify-between items-center'>
    ...
    <div className="dropdown">
      ...
      <ul
        tabIndex="-1"
        className="menu menu-sm dropdown-content bg-black/40  backdrop-blur-lg rounded-box z-1 mt-3 w-52 p-2 shadow">
        {link}
      </ul>
    </div>
  ...
  <input className='bg-transparent outline-none text-sm text-white placeholder-white/60 w-24 md:w-40' type="search" required placeholder="Search" />
</label>
<div className="avatar">
  <div className="ring-[#facc15] ring-offset-black/40  rounded-full ring-2 ring-offset-2">
    <img className='w-8' src="https://i.ibb.co.com/ksFBV7CV/Shahriar-Raj-png.jpg" />
  </div>
</div>
  </div>
  </div>
